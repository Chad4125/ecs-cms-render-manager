...
class MyExecutor(unreal.MoviePipelinePythonHostExecutor):
    ...
    def execute_delayed(self, queue):
        ...
        #unreal.get_default_object(unreal.MoviePipelinePythonHostExecutor).executor_class = "\Game\Python\myExecutor.py"
        #unreal.get_default_object(unreal.MoviePipelinePythonHostExecutor).executor_class = "\Game\Python\myExecutor.py.MyExecutor"
