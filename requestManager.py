...
app = Flask(__name__)
FLASK_EXE = r'C:\Program Files\Epic Games\UE_5.3\Engine\Binaries\ThirdParty\Python3\Win64\Scripts\flask.exe'
...
if __name__ == '__main__':
    ...
    env = os.environ.copy()
    env['PYTHONPATH'] = env.get('PYTHONPATH', '') + os.pathsep + MODULE_PATH
